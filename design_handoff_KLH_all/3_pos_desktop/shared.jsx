...
const Ic = {
  ...
  print: (p) => (<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M6 9V3h12v6M6 18H4a1 1 0 0 1-1-1v-5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5a1 1 0 0 1-1 1h-2M7 14h10v7H7z"/></svg>),
  layers: (p) => (<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M12 3 3 8l9 5 9-5-9-5zM3 14l9 5 9-5M3 11l9 5 9-5" opacity=".95"/></svg>),
};

/* ---------- cart store ---------- */
function useCart(initial) {
  const [lines, setLines] = useState(initial || {}); // id -> qty
  ...
  const replace = useCallback((obj) => setLines({ ...(obj || {}) }), []);
  ...
  return { lines, add, setQty, clear, replace, count, items, subtotal };
}
