...
function chartSheet_() {
  ...
  if (!s) {
    ...
    var seed = [
      ...
      ['5410', 'เบี้ยปรับ/เงินเพิ่ม สรรพากร',     'ค่าใช้จ่าย',  true],
      ['5900', 'ค่าใช้จ่ายอื่น',                  'ค่าใช้จ่าย',  true],
      ['2100', 'ชำระเจ้าหนี้การค้า',              'หนี้สิน',    true],
      ['2300', 'ภาษีมูลค่าเพิ่มนำส่ง (สรรพากร)',  'หนี้สิน',    true],
...
function addTaxAccounts() {
  ...
  coaEnsure_('5400','ภาษี','ค่าใช้จ่าย');
  coaEnsure_('5410','เบี้ยปรับ/เงินเพิ่ม สรรพากร','ค่าใช้จ่าย');   // เบี้ยปรับ = ค่าใช้จ่าย (เข้า P&L)
  return 'เพิ่มผังบัญชีสรรพากร: 2300 ภาษีมูลค่าเพิ่มนำส่ง (หนี้สิน) · 5400 ภาษี · 5410 เบี้ยปรับ/เงินเพิ่ม (ค่าใช้จ่าย)';
}
